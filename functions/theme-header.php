...
<?php
	...
	function mms_print_scripts() {
		...
		if(is_front_page()) {
			wp_enqueue_script('mms-full-width-bg', get_stylesheet_directory_uri() . '/js/libs/jquery.backgroundsize.js', array('jquery'), '2.1', false);
			wp_enqueue_script('mms-flexslider', get_stylesheet_directory_uri() . '/js/libs/jquery.flexslider-min.js', array('jquery'), '1.0', false);
		}
